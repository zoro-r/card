  ...
  useEffect(() => {
    if (visible && employee) {
      const formData = {
        ...
        probationEndDate: employee.probationEndDate ? dayjs(employee.probationEndDate) : undefined,
      };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const employeeData = {
        ...
        canEditCompanyInfo: employee.canEditCompanyInfo,
